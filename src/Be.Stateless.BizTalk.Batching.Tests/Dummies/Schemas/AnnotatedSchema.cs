...
namespace Be.Stateless.BizTalk.Dummies.Schemas
{
  ...
  <xs:element name='Annotated'>
    <xs:annotation>
      <xs:appinfo>
        <san:EnvelopeMapSpecName>Be.Stateless.BizTalk.Dummies.Maps.IdentityTransform, Be.Stateless.BizTalk.Batching.Tests, Version=2.1.0.0, Culture=neutral, PublicKeyToken=3707daa0b119fc14</san:EnvelopeMapSpecName>
